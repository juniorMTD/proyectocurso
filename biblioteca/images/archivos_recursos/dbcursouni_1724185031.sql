...
CREATE TABLE IF NOT EXISTS `dbcursouni`.`encuestax` (
  ...
  `estado_encuesta` TINYINT NULL,
  PRIMARY KEY (`idencuestax`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `dbcursouni`.`tipo_preguntax`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbcursouni`.`tipo_preguntax` (
  `idtipo_preguntax` INT NOT NULL AUTO_INCREMENT,
  `tipo_pregunta` VARCHAR(80) NOT NULL,
  PRIMARY KEY (`idtipo_preguntax`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbcursouni`.`preguntax` (
  ...
  `estado_preg` TINYINT NULL,
  `idencuestax` INT NOT NULL,
  `idtipo_preguntax` INT NOT NULL,
  ...
  CONSTRAINT `encuestax1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `tipo_preguntax1`
    FOREIGN KEY (`idtipo_preguntax`)
    REFERENCES `dbcursouni`.`tipo_preguntax` (`idtipo_preguntax`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbcursouni`.`respuestax` (
  `idrespuestax` INT NOT NULL AUTO_INCREMENT,
  `f_respuesta` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `estado_respuesta` TINYINT NULL,
  `idpreguntax` INT NOT NULL,
  `idusux` INT NOT NULL,
  `idopcionx` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `dbcursouni`.`empleado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbcursouni`.`empleado` (
...
-- -----------------------------------------------------
-- Table `dbcursouni`.`pagox`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbcursouni`.`pagox` (
  `idpagox` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `dbcursouni`.`notificacionx_usuariox`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbcursouni`.`notificacionx_usuariox` (
  `idnotificacionx_usuariox` INT NOT NULL AUTO_INCREMENT,
  `leido` TINYINT NULL,
  `idnotificacionx` INT NOT NULL,
  `idusuariox` INT NOT NULL,
  PRIMARY KEY (`idnotificacionx_usuariox`),
  CONSTRAINT `notificacionx1`
    FOREIGN KEY (`idnotificacionx`)
    REFERENCES `dbcursouni`.`notificacionx` (`idnotificacionx`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `dbcursouni`.`encuesta_usux`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbcursouni`.`encuesta_usux` (
  `idencuesta_usux` INT NOT NULL AUTO_INCREMENT,
  `completada` TINYINT NULL,
  `fecha_completada` TIMESTAMP NULL,
  `idencuestax` INT NOT NULL,
  `idusux` INT NOT NULL,
  PRIMARY KEY (`idencuesta_usux`),
  CONSTRAINT `encuestax2`
    FOREIGN KEY (`idencuestax`)
    REFERENCES `dbcursouni`.`encuestax` (`idencuestax`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
